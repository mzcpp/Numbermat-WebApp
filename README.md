...
To use this application, you can access it via [GitHub Pages](https://maarioz.github.io/Numbermat-WebApp/) or you can download the ZIP of this repository, and open the index.html file in your internet browser.
